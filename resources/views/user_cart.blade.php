@php use Illuminate\Support\Facades\Session; @endphp @extends('layouts.app')
@section('title')
{{ Auth::User()->name }} | Cart @endsection @section('content')
<div class="container">
    <div class="social mb-2">
        <a href="https://www.facebook.com/EllenRaLinde/"
            ><i class="fa fa-facebook-official" aria-hidden="true"></i>
        </a>
        <a href="https://www.instagram.com/ellenralinde/"
            ><i class="fa fa-instagram" aria-hidden="true"></i>
        </a>
        <a href="https://www.facebook.com/technovikinglabel/"
            ><i class="fa fa-facebook-official" aria-hidden="true"></i>
        </a>
        <a href="https://www.instagram.com/technovikinglabel/"
            ><i class="fa fa-instagram" aria-hidden="true"></i>
        </a>
        <a href="https://www.facebook.com/rahennatattoo"
            ><i class="fa fa-instagram" aria-hidden="true"></i>
        </a>
        <a href="https://www.instagram.com/ralindetattoo/"
            ><i class="fa fa-facebook-official" aria-hidden="true"></i>
        </a>
    </div>
    ...
    <div class="row">
        <div class="col-sm-7">
            @php $total = 0; @endphp @if ($user_cart->isNotEmpty())
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @php $total += $cart->price * $cart->qty/100
                        *session::get('vat')+ $cart->price * $cart->qty; @endphp
                        @endforeach
                    </tr>
            ...
            @else
            <div class="alert alert-danger empty">Your cart is empty!</div>
            @endif
        </div>
        ...
        <div class="col-sm-5">
            ...
            <form action="/charge" method="get" id="payment-form">
                ...
                <div class="payment-card">
                    ...
                    <input
                        type="text"
                        name="invoice_adress"
                        placeholder="Invoice adress and postal code"
                        id="address"
                    />
                    <input
                        type="text"
            ...
            <div class="payment-paypal">
                ...
                <form action="/paypal-payment" method="get">
                    ...
                    />
                    <input type="text" name="country" placeholder="Country" />
                    <button type="submit" name="paypal" class="pay">
                        Pay now
                    </button>
                </form>
            </div>
...
<script>
    const stripe = Stripe(
        "pk_test_51Kf6n1JJ62elaW6DvIIeg3wdI2XJYVC2tj5M4makMXZWMcNVgUUWh9gKiJY6UUE6QKIApFSuo9pt3WUsU18MRkqQ004G2Li9Sg"
    );
